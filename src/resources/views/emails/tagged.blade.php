                                            ...
                                            <tr>
                                                <td style="text-align:center; margin:0 auto;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <![endif]-->
                                                        <a href="{{$appURL}}"
                                                           style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:220px;-webkit-text-size-adjust:none;">{{$appName}}</a>
                                                        <!--[if mso]>
                                                        </center>
                                                        </v:rect>
                                                        <![endif]-->
